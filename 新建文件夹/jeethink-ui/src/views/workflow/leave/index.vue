<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="leaveList">
      ...
      <el-table-column label="项目结束时间" align="center" prop="leaveEndTime">
      </el-table-column>
      <el-table-column label="项目时长" align="center" prop="totalTime"/>
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除项目申请流程编号为"' + ids + '"的数据项?', '警告', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(function () {
      ...
      handleExport() {
        ...
        this.$confirm('是否确认导出所有项目申请流程数据项?', '警告', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(function () {
